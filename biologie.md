...
<!-- <-- On identifie un pré-requis qui est la vision, pour motiver  -->
<!-- <-- On joue sur l'environnement mis à disposition, pas sur les collaborateurs  -->
<!-- <-- Par exemplarité, cela va diffuser sur ses membres et sur l'organisation existante  -->
<!-- <-- ------------- FIN EVOLUER -------------  -->
...
<!-- <-- ------------- Schéma avec cercles d'ancrage et enjeux -------------  -->
...
<!-- <-- ------------- Ajouter un schéma de type Design Thinking -------------  -->
<!-- <-- ------------- Identification des clients, freins ... -------------  -->
...
<!-- <-- ------------- Lien entre COMMIT et CODIR qui diffuse en interne -------------  -->
...
<!-- <-- ------------- Ajouter une charte, équivalente à la constitution en holacratie ----  -->
...
<!-- <-- ------------- Schéma avec la ligne Enjeu juste 3 instances sur 1 mois -------------  -->
<!-- <-- ------------- On décline un objectif macro type entretien tripartite -------------  -->
<!-- <-- ------------- L'enjeu se l'approprie et décline les options et le will -------------  -->
<!-- <-- ------------- On constate les progrès régulièrement -------------  -->
<!-- <-- ------------- On peut donc mettre 3 "GROW" les uns après les autres -------------  -->
<!-- <-- ------------- Au niveau des équipes -------------  -->
<!-- <-- ------------- Au niveau des enjeux -------------  -->
<!-- <-- ------------- Au niveau des l'ensemble -------------  -->
...
<!-- <-- ------------- Description dans la charte -------------  -->
<!-- <-- ------------- Equivalent à un contrat de coaching -------------  -->
...
<!-- <-- ------------- OKR au niveau de l'organisation -------------  -->
<!-- <-- ------------- Déclinaison des OKR au niveau des enjeux -------------  -->
...
<!-- <-- ------------- On introduit la notion de sprint avec les démos -------------  -->
...
<!-- <-- ------------- Différents streams : équipe, enjeu, dynamique puis réalité -------------  -->
...
<!-- <-- ------------- Etapes préalables à la Plénière #1 -------------  -->
<!-- <-- ------------- FIN CAPITALISER -------------  -->
...
<!-- <-- ------------- Rituels en reprenant ce qui a déjà été dit -------------  -->
<!-- <-- ------------- Insister sur la posture des "animateurs" -------------  -->
<!-- <-- ------------- Questionner le fond ET LA FORME des rituels lors des rétro -------------  -->
...
<!-- <-- ------------- Présenter un enjeu communication avec des OKR -------------  -->
<!-- <-- ------------- FIN COEXISTER -------------  -->
